...
class CategoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.Category.index')->with(compact('categories', 'Types', 'dis_type', 'moduleaccess', 'adminrole', 'Nametype', 'EnName', 'offerCategory'));
    }
		...
		if($bulkaction == 'delete') {
			if(is_array($typeids)) {
				foreach($typeids as $typeids) {					
					Category::where('TypeId', '=', $typeids)->delete();
				}
			}	
