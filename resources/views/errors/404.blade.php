@include('header')
@php
    $staticpage = \App\Models\PageContent::where('UniqueKey', 'page-not-found')->first();
    $bannerads = \App\Models\Bannerads::where([['ban_status', '=', '1'],['PageId', '=', 'page-not-found']])->orderBy('display_order', 'asc')->get();
@endphp
<div class="container">
