                        ...
                        <div class="col-md-12 col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <form class="form form-horizontal" name="banner_master" id="banner_master" method = "post" action="{{ url('/admin/banner_master') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                ...
                                                                <input type="text" id="ban_link" class="form-control" name="ban_link" placeholder="Masthead Images Link">
													...
													<div class="col-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class= "custom-file">
                                                              ...
                                                              <input type="file" name="EnBanMobileimage" class="custom-file-input imageUpload1" /> 
												...
												<input type="hidden" id="display_order" class="form-control" name="display_order" placeholder="Display Order" value="0">
                                                    <div class="col-12">
