...
<textarea name="UniqueKey" class="form-control" required>{{ $product->UniqueKey }}</textarea>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
																...
																@if(count($categories) > 0)						
																	...
																	$subcats = \App\Models\Category::where('ParentLevel','=',$cate->TypeId)->orderBy('EnName', 'ASC')->get();							@endphp								
													...
													<div class="col-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="geeks"> 
                                                              ...
                                                              <img src="{{ url('/uploads/product/large/'.$product->LargeImage) }}" alt="{{ $product->EnName }}">

                                                            </div>

                                                            @endif			

                                                            <input type="hidden" name="LargeImage" value="{{ $product->LargeImage }}">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class= "custom-file">
															  ...
															  @if($product->Tds != '') 
																...
																<a href="{{ url('/uploads/product/tds/'.$product->Tds) }}" target="_blank">
													...
													<div class="col-12">
                                                        ...
                                                        <div class="form-group row">
															...
															<a href="{{ url('/uploads/product/sds/'.$product->Sds) }}" target="_blank">
    ...
    if (input.files && input.files[0]) {
        ...
        $.each(input.files, function() {
            ...
            reader.onload = function (e) {           
                ...
                $largeimages.html('<img src="'+ e.target.result+'" />')
