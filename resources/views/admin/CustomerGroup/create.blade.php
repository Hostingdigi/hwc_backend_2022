                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                    <form class="form form-horizontal" name="addcountry" id="addcountry" method = "post" action="{{ url('/admin/customergroup') }}" enctype="multipart/form-data">                                            
                                            {{ csrf_field() }}
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="GroupTitle" class="form-control" name="GroupTitle" placeholder="Group Title" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                            <div class="col-md-4">
                                                                <input type="text" id="DiscountValue" class="form-control" name="DiscountValue" placeholder="Discount Value">
                                                            </div>
                                                            <div class="col-md-4">
