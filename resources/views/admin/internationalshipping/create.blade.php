                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                       <form class="form form-horizontal" name="addcountry" id="addcountry" method = "post" action="{{ url('/admin/international_shipping_methods') }}" enctype="multipart/form-data">                                                 
                                            {{ csrf_field() }}
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
													...
													<div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">                                                                
																<textarea name="ShipCost" class="form-control"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
													<div class="col-12">
                                                        ...
                                                        <div class="form-group row">
															...
															<div class="col-md-2">
                                                                <input type="text" id="PriceRange70" class="form-control" name="PriceRange70" placeholder="Price">
                                                            </div>
                                                            <div class="col-md-2">
                                                                 <input type="text" id="PriceRange300" class="form-control" name="PriceRange300" placeholder="Price">
                                                            </div>
															<div class="col-md-2">
                                                                 <input type="text" id="PriceRange99999" class="form-control" name="PriceRange99999" placeholder="Price">
                                                            </div>
														</div>
                                                    </div>
													<div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
																<input type="text" name="FreeShippingCost" class="form-control" id="FreeShippingCost" placeholder="Free Shipping Cost">
                                                            </div>
                                                        </div>
                                                    </div>
													<div class="col-12">
