                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                    <form class="form form-horizontal" name="page_content" id="page_content" method = "post" action="{{ url('/admin/page_content/'.$page_content->id ) }}" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="page_title" class="form-control" name="page_title" value="{{ $page_content->page_title }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="menu_notes" class="form-control" name="menu_notes" value="{{ $page_content->menu_notes }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="page_url" class="form-control" name="page_url" value="{{ $page_content->page_url }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                            <textarea name="content" id="editor" class="form-control" style="height:200px;" value="{{ $page_content->content }}"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
