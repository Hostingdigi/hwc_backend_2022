                        ...
                        <div class="col-md-12 col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <form class="form form-horizontal" name="addbrand" id="addbrand" method = "post" action="{{ url('/admin/brands') }}" enctype="multipart/form-data">                                            
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group row">
															...
															<textarea name="EnName" class="form-control" placeholder="Brand Name" required></textarea>                                                                
													...
													<div class="col-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <textarea id="editor" class="form-control" name="Details" placeholder="Type page content ..." ></textarea>
													...
													<div class="col-12">
                                                        ...
                                                        <div class="form-group row">
                                                           ...
                                                           <input type="checkbox" name="dis_type" value="1"> 
													...
													<div class="col-12">
                                                        ...
                                                        <div class="form-group row">
                                                           ...
                                                           <input type="checkbox" name="exclude_global_dis" value="1"> 
