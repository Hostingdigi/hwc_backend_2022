...
<div class="app-content content" style="background-color:#fff;">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">BRAND VIEW
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <a href = "{{ url('/admin/brand') }}"><button type="button" class="btn btn-relief-warning mr-1 mb-1">Add</button></a>
                            ...
                            <tbody>
                                @foreach($brand as $brand)
                                    <tr>
                                        ...
                                        <td>{{ $brand->category_url }}</td>
                                       
                                        <td>{{ $brand->status }}</td>
                                        <td><a href = "{{ url('/admin/brand/'.$brand->id) }}">
                                        <button type="button" class="btn btn-relief-success mr-1 mb-1 waves-effect waves-light">
                                        <i class="fa fa-pencil"></i></button></a>
                                        <a href = "{{ url('/admin/destroy/'.$brand->id) }}">
