                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" name="deliveryinfo_frm" id="deliveryinfo_frm" method = "post" action="{{ url('/admin/orders/updatedeliveryinfo') }}" enctype="multipart/form-data">    
											<input type="hidden" name="orderid" value="{{ $order->order_id}}">
											<input type="hidden" name="deliveryinfoid" value="{{ $infoid }}">	
											{{ csrf_field() }}
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
													...
													<div class="col-12" id="ninjaform" style="display:block;">
                                                        <div class="form-group row">
                                                            <div class="col-md-4">
                                                                <span>Box Size</span>
                                                            </div>
