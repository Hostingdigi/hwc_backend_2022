...
<div class="app-content content" style="background-color:#fff;">
        ...
        <div class="content-wrapper" style="width:100%; margin:0 auto;">
                ...
                <div class="content-header-left col-md-12 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12 text-center">
                            <h2 class="content-header-title">Manage Pending Orders / Quotations</h2>                            
                        </div>
            ...
            <section id="data-list-view" class="data-list-view-header">
				<form name="order_filter_frm" id="order_filter_frm" action="{{ url('/admin/pendingorders') }}" method="GET">
				...
				<form class="form form-horizontal" name="order_frm" id="order_frm" method = "post" action="{{ url('/admin/pendingorders/pendingbulkaction') }}" enctype="multipart/form-data">                                            
				{{ csrf_field() }}
				...
				<div class="row" style="padding:10px 0;">
					...
					<select name="bulk_action" id="bulk_action" class="form-control">
						...
						<option value="converted">Mark as Converted (Invoice)</option>
					</select>
					</div>
					@endif
				</div>
