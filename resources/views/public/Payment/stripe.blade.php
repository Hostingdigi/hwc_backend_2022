	...
	<div class="container">
	    ...
	    <div class="row pb-0">
            <div class="col-sm-12 pb-0">
                ...
                <p class="text-danger text-bold">{!! \Session::get('pay_error') !!}</p>
                </div>
            </div>
        </div>
	    @endif
        <div class="row pb-0 d-none" id="sPMsgDiv">
            <div class="col-sm-12 pb-0">
                <div class="alert alert-danger" role="alert">
                    <p id="sPMsg" class="text-danger text-bold"></p>
                </div>
            </div>
        </div>
...
$(function() {
  ...
  function stripeResponseHandler(status, response) {
        ...
        if (response.error) {
            $('#ordbtn').show();
		    $('#loading').hide();
            $("#sPMsgDiv").removeClass("d-none");
            $("#sPMsg").html(response.error.message);
            // $('.error')
            //     .removeClass('hide')
            //     .find('.alert')
