								...
								<select class="country" name="bill_country" id="bill_country" required>
									...
									@if($countries)
										@foreach($countries as $country)
											<option value="{{ $country->countrycode }}" @if(Session::has('billinginfo')) @if($country->countrycode == $countryCode) selected @endif @else  
											@if($customer) @if($country->countryid == $customer->cust_country || $country->countrycode == $customer->cust_country) selected @endif @endif @endif>{{ $country->countryname }}</option>
										@endforeach
									@endif                                        
								</select>
							</div>
