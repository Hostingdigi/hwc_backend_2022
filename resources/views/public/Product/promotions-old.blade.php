												...
												<div class="col-lg-3 col-md-6">
													<div class="tab-item">
														<div class="tab-img">
															...
															@else
																<img class="main-img img-fluid" src="{{ url('/images/noimage.png') }}" style="height:286px; width:100%;" alt="{{ $product->EnName }}">																
															@endif
															</a>
														...
														<div class="tab-heading">
															<p><a href="{{ url('/prod/'.$product->UniqueKey) }}">
														...
														<div class="img-content d-flex justify-content-between">
															<div class="wid_full">
																...
																<ul class="list-unstyled list-inline price">
																	...
																	<li class="list-inline-item strikeoutprice">${{ number_format($product->Price, 2) }}</li>
																	@endif
																</ul>
