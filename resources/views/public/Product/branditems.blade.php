...
<section id="breadcrumbs" class="breadcrumbs">
  <div class="container">
	<ol>
		...
		<li><div class="pageheading">{{ $brand }}</div></li>
	</ol>
  </div>
</section>
@php 
...
$(document).ready(function() {
	$('#sortby').change(function() {
		...
		if(sortby != '' && showrecord != '') {
			window.location = "{{ url('/brand/'.$brand) }}"+"?sortby="+sortby+"&show="+showrecord+"&cid="+cid+"&bid="+bid;
		}
	});
...
function setcategory(catagoryid) {
	...
	var sortby = $('#sortby').val();
	var showrecord = $('#showrecord').val();
	window.location = "{{ url('/brand/'.$brand) }}"+"?sortby="+sortby+"&show="+showrecord+"&cid="+catid+"&bid="+bid;
}
