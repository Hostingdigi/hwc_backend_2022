...
<section id="breadcrumbs" class="breadcrumbs">
  <div class="container">
	<ol>
		...
		<li><div class="pageheading">Search</div></li>
	</ol>
  </div>
</section>
@php 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="view-all sidelist"><a href="{{ url('/search?searchkey='.$searchkey) }}">Clear Filter</a></div>
											...
											@foreach($promoproducts as $product)
												...
												<div class="col-lg-3 col-md-6 col-6">
													<div class="tab-item">
														...
														<p><a href="{{ url('/prod/'.$product->UniqueKey) }}" alt="{{ $product->EnName }}" title="{{ $product->EnName }}" title="{{ $product->EnName }}" title="{{ $product->EnName }}">@if(strlen($product->EnName) > 22){{ substr($product->EnName, 0, 30) }}...@else {{ $product->EnName }} @endif</a></p>
														</div>
...
$(document).ready(function() {
	$('#sortby').change(function() {
		...
		if(sortby != '' && showrecord != '') {
			window.location = "{{ url('/search/') }}"+"?searchkey="+searchkey+"&sortby="+sortby+"&show="+showrecord+"&cid="+cid+"&bid="+bid;
		}
	});
	...
	$('#loadmore').click(function() {
		...
		$.ajax({
			...
			data: {'page': pagenum, 'IsPromotion': '0', 'cid': cid, 'bid': bid, 'sortby': sortby, 'show': showrecord, 'searchkey': searchkey},
...
function setcategory(catagoryid) {
	...
	//if(sortby != '' && showrecord != '') {
		window.location = "{{ url('/search/') }}"+"?searchkey="+searchkey+"&sortby="+sortby+"&show="+showrecord+"&cid="+catid+"&bid="+bid;
	//}
}
